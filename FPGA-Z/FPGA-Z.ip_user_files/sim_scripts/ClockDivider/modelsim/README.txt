...
#
# Generated by export_simulation on Tue Apr 19 12:14:00 +0200 2016
#
################################################################################
...
switch to the './ClockDivider.sh' script.

./ClockDivider.sh -reset_run
...
./ClockDivider.sh -noclean_files

For more information on the script, please type './ClockDivider.sh -help'.
