...
module ClockDivider(clkIn, clk108M, clk_cpu, clk2cpu, clk4cpu, clk6cpu)
/* synthesis syn_black_box black_box_pad_pin="clkIn,clk108M,clk_cpu,clk2cpu,clk4cpu,clk6cpu" */;
  input clkIn;
  output clk108M;
  output clk_cpu;
  output clk2cpu;
