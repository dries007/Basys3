...
set rc [catch {
  ...
  add_files -quiet /home/dries/Projects/Basys3/FPGA-Z/FPGA-Z.runs/synth_1/Ram.dcp
...
set rc [catch {
  ...
  catch {write_hwdef -file Ram.hwdef}
  place_design 
...
set rc [catch {
  ...
  report_power -file Ram_power_routed.rpt -pb Ram_power_summary_routed.pb
...
set rc [catch {
  ...
  write_bitstream -force Ram.bit -raw_bitfile -bin_file
