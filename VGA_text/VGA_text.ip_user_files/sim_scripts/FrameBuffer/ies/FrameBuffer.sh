...
compile()
{
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../VGA_text.srcs/sources_1/ip/FrameBuffer/sim/FrameBuffer.vhd" \
...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.FrameBuffer $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.FrameBuffer -input simulate.do
}
# Script usage
usage()
{
